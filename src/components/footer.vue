          ...
          >
            ...
            <v-card>
              ...
              <v-card-text class="text-md-center text-justify">
                ...
                <strong>Politica de privacidad \n </strong> Ilanguage te informa sobre su Política de Privacidad respecto del tratamiento y protección de los datos de carácter personal de los usuarios y clientes que puedan ser recabados por la navegación o contratación de servicios a través del sitio Web www.ilanguage.com
                En este sentido, el Titular garantiza el cumplimiento de la normativa vigente en materia de protección de datos personales, reflejada en la Ley Orgánica 3/2018, de 5 de diciembre, de Protección de Datos Personales y de Garantía de Derechos Digitales (LOPD GDD). Cumple también con el Reglamento (UE) 2016/679 del Parlamento Europeo y del Consejo de 27 de abril de 2016 relativo a la protección de las personas físicas (RGPD).
                El uso de sitio Web implica la aceptación de esta Política de Privacidad así como las condiciones incluidas en el Aviso Legal. <strong>Obtención de datos personales \n </strong> Para navegar por www.ilanguage.com no es necesario que facilites ningún dato personal. Los casos en los que sí proporcionas tus datos personales son los siguientes:
                <ul id="example-2">
                  <li v-for="(datoPersonal) in datosPersonales" v-bind:key="datoPersonal.id">
                     {{ datoPersonal.content }}
                  </li>
                </ul>
                <strong>Tus derechos</strong> El Titular te informa que sobre tus datos personales tienes derecho a: /n
                <ul id="example-1">
                ...
                <strong>Contenido de otros sitios web </strong> Las páginas de este sitio Web pueden incluir contenido incrustado (por ejemplo, vídeos, imágenes, artículos, etc.). El contenido incrustado de otras web se comporta exactamente de la misma manera que si hubieras visitado la otra web.
                Estos sitios Web pueden recopilar datos sobre ti, utilizar cookies, incrustar un código de seguimiento adicional de terceros, y supervisar tu interacción usando este código.
                <strong>Política de cookies</strong> Para que este sitio Web funcione correctamente necesita utilizar cookies, que es una información que se almacena en tu navegador web.
