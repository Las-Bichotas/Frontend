<template>
  <div>
    ...
    <div v-for="(subscription) in state.subscriptions"
         v-bind:key="subscription.id" class="crdplans" :class="{'--proPlan': state.proPlan}">
      <v-card
      ...
      >
        ...
        <v-card-title><strong>{{subscription.name}} </strong></v-card-title>
  ...
  setup() {
    ...
    const state = reactive({
      ...
      benefits: [
        ...
        {id: 1, benefitDescription:"Aceptamos como metodo de pago todas tus tarjetas"},
